...
// Database settings.
const DB_HOST = ''; // The hostname of your database server. Required.
const DB_USER = ''; // The username you'll use to access the database. Required.
const DB_PASS = ''; // The password you'll use to access the database. Optional.
const DB_NAME = ''; // The name of the database. Required.
...
const CLOUDINARY_CLOUDNAME = 'dahftan4m'; // The cloud name of your Cloudinary account. Required.
